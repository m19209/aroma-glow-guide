...
var name$2, version$2, description$2, main$2, types$2, files$2, scripts$2, repository$2, keywords$2, engines$2, author$2, license$2, devDependencies$2, dependencies$2, package_default$2;
...
var require_v1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _stringify = require_stringify$2();
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { default: obj };
	}
	var _nodeId;
...
var require_v35 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.default = v35;
	var _stringify = require_stringify$2();
	var _parse = _interopRequireDefault(require_parse$2());
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { default: obj };
	}
...
var require_dist$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _validate = _interopRequireDefault(require_validate());
	var _stringify = _interopRequireDefault(require_stringify$2());
	var _parse = _interopRequireDefault(require_parse$2());
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { default: obj };
	}
...
var require_node = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	formatters.o = function(v) {
		...
		return util$7.inspect(v, this.inspectOpts).split("\n").map((str) => str.trim()).join(" ");
	};
	/**
	...
	*/
	formatters.O = function(v) {
		this.inspectOpts.colors = this.useColors;
		return util$7.inspect(v, this.inspectOpts);
	};
}));
//#endregion
//#region node_modules/debug/src/index.js
var require_src$6 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
...
var require_helpers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function req(url, opts = {}) {
		const req = ((typeof url === "string" ? url : url.href).startsWith("https:") ? https$1 : http$2).request(url, opts);
...
var require_dist$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Agent = class extends http$1.Agent {
		constructor(opts) {
			super(opts);
			this[INTERNAL] = {};
		}
		...
		*/
		...
		createSocket(req, options, cb) {
			...
			Promise.resolve().then(() => this.connect(req, connectOpts)).then((socket) => {
				...
				if (socket instanceof http$1.Agent) try {
...
var require_parse_proxy_response = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var debug = (0, __importDefault(require_src$6()).default)("https-proxy-agent:parse-proxy-response");
...
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var debug_1 = __importDefault(require_src$6());
...
var require_gaxios = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var querystring_1$1 = __importDefault(__require("querystring"));
	...
	_a = Gaxios, _Gaxios_instances = /* @__PURE__ */ new WeakSet(), _Gaxios_urlMayUseProxy = function _Gaxios_urlMayUseProxy(url, noProxy = []) {
		var _b, _c;
		const candidate = new url_1$1.URL(url);
		...
		} else if (rule instanceof url_1$1.URL) {
		...
		if (opts.multipart === void 0 && opts.data) {
			...
			const bodyStream = new stream_1$1.PassThrough();
			opts.body = bodyStream;
			(0, stream_1$1.pipeline)(this.getMultipartRequest(opts.multipart, boundary), bodyStream, () => {});
		}
...
var require_logging_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var process$2 = __importStar(__require("node:process"));
	var util$6 = __importStar(__require("node:util"));
	...
	*/
	var DebugLogBackendBase = class {
		constructor() {
			...
			let nodeFlag = (_a = process$2.env[exports.env.nodeEnables]) !== null && _a !== void 0 ? _a : "*";
	...
	*/
	...
	var DebugBackend = class extends DebugLogBackendBase {
		...
		setFilters() {
			var _a;
			const existingFilters = (_a = process$2.env["NODE_DEBUG"]) !== null && _a !== void 0 ? _a : "";
...
var require_src$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var gaxios_1 = require_src$5();
	var jsonBigint = require_json_bigint();
	var gcp_residency_1 = require_gcp_residency();
	var logger = require_src$4();
	...
	var OAuth2Client = class OAuth2Client extends authclient_1.AuthClient {
		...
		*/
		generateAuthUrl(opts = {}) {
			...
			return this.endpoints.oauth2AuthBaseUrl.toString() + "?" + querystring$2.stringify(opts);
		}
...
var require_data_stream = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	util$5.inherits(DataStream, Stream$3);
...
var require_sign_stream = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	util$3.inherits(SignStream, Stream$2);
...
var require_src$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var GoogleToken = class {
		...
		*/
		constructor(options) {
			...
			this.transporter = { request: (opts) => (0, gaxios_1.request)(opts) };
		...
		*/
		async getCredentials(keyFile) {
			switch (path$1.extname(keyFile)) {
				...
				case ".der":
				case ".crt":
				case ".pem": return { privateKey: await readFile(keyFile, "utf8") };
				case ".p12":
	...
	_GoogleToken_inFlightRequest = /* @__PURE__ */ new WeakMap(), _GoogleToken_instances = /* @__PURE__ */ new WeakSet(), _GoogleToken_getTokenAsync = async function _GoogleToken_getTokenAsync(opts) {
		if (__classPrivateFieldGet(this, _GoogleToken_inFlightRequest, "f") && !opts.forceRefresh) return __classPrivateFieldGet(this, _GoogleToken_inFlightRequest, "f");
		try {
		...
		if (!this.key && this.keyFile) {
			...
			if (!creds.clientEmail) __classPrivateFieldGet(this, _GoogleToken_instances, "m", _GoogleToken_ensureEmail).call(this);
		}
...
var require_filesubjecttokensupplier = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var readFile = (0, util_1.promisify)((_a = fs$3.readFile) !== null && _a !== void 0 ? _a : (() => {}));
	var realpath = (0, util_1.promisify)((_b = fs$3.realpath) !== null && _b !== void 0 ? _b : (() => {}));
	var lstat = (0, util_1.promisify)((_c = fs$3.lstat) !== null && _c !== void 0 ? _c : (() => {}));
	/**
...
//#endregion
//#region node_modules/googleapis-common/build/src/apiIndex.js
	...
	(function(root, factory) {
		...
		*/
		UrlTemplate.prototype.getValues = function(context, operator, key, modifier) {
			...
			if (this.isDefined(value) && value !== "") if (typeof value === "string" || typeof value === "number" || typeof value === "boolean") {
				value = value.toString();
				if (modifier && modifier !== "*") value = value.substring(0, parseInt(modifier, 10));
				result.push(this.encodeValue(operator, value, this.isKeyOperator(operator) ? key : null));
			} else if (modifier === "*") if (Array.isArray(value)) value.filter(this.isDefined).forEach(function(value) {
				result.push(this.encodeValue(operator, value, this.isKeyOperator(operator) ? key : null));
			}, this);
			else Object.keys(value).forEach(function(k) {
...
//#endregion
//#region node_modules/googleapis-common/build/src/isbrowser.js
...
//#endregion
//#region node_modules/googleapis-common/build/src/http2.js
var require_http2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var common_1 = require_common$1();
	var { HTTP2_HEADER_CONTENT_ENCODING, HTTP2_HEADER_CONTENT_TYPE, HTTP2_HEADER_METHOD, HTTP2_HEADER_PATH, HTTP2_HEADER_STATUS } = http2.constants;
	var DEBUG = !!process$1.env.HTTP2_DEBUG;
	/**
		...
		return new Promise((resolve, reject) => {
			try {
				req = session.request(headers).on("response", (headers) => {
					...
					let stream = req;
					if (headers[HTTP2_HEADER_CONTENT_ENCODING] === "gzip") stream = req.pipe(zlib$1.createGunzip());
					if (opts.responseType === "stream") {
						res.data = stream;
						resolve(res);
						return;
...
//#endregion
//#region node_modules/googleapis-common/package.json
...
var name, version, description, repository, main, types, files, scripts, keywords, author, license, dependencies, devDependencies, engines, package_default;
...
//#endregion
//#region node_modules/googleapis-common/build/src/apirequest.js
var require_apirequest = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	async function createAPIRequestAsync(parameters) {
		var _a, _b, _c, _d;
		const options = extend(true, {}, ((_a = parameters.context.google) === null || _a === void 0 ? void 0 : _a._options) || {}, parameters.context._options || {}, parameters.options);
		...
		*/
		...
		if (authClient && typeof authClient === "object") {
			...
			} else return authClient.request(options);
		} else return new google_auth_library_1.DefaultTransporter().request(options);
	}
	/**
...
//#endregion
//#region node_modules/googleapis-common/build/src/authplus.js
...
//#endregion
//#region node_modules/googleapis-common/build/src/endpoint.js
...
//#endregion
//#region node_modules/googleapis-common/build/src/discovery.js
var require_discovery = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Discovery = void 0;
	var fs = __require("fs");
	var google_auth_library_1 = require_src$1();
	var resolve = __require("url");
...
//#endregion
//#region node_modules/googleapis-common/build/src/index.js
...
//#endregion
//#region node_modules/@googleapis/sheets/build/v4.js
var require_v4 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.sheets_v4 = void 0;
	var googleapis_common_1 = require_src();
	(function(sheets_v4) {
		/**
		* Google Sheets API
		*
	...
	})(exports.sheets_v4 || (exports.sheets_v4 = {}));
}));
//#endregion
//#region node_modules/@googleapis/sheets/build/index.js
var require_build = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "sheets_v4", {
		enumerable: true,
		get: function() {
			return v4_1.sheets_v4;
		}
	});
	exports.VERSIONS = { v4: v4_1.sheets_v4.Sheets };
