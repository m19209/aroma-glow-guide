...
function CheckoutPage() {
  ...
  if (success) {
    return (
      <div style={{ minHeight: "100vh", background: "radial-gradient(circle at 50% 30%, rgba(201,168,76,.12) 0%, rgba(250,250,248,1) 70%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "'Cinzel', serif", direction: dir }}>
        <div style={{ maxWidth: "540px", width: "100%", background: "rgba(255,255,255,.9)", backdropFilter: "blur(16px)", border: "1px solid rgba(201,168,76,.3)", borderRadius: "16px", padding: "64px 48px", textAlign: "center", boxShadow: "0 30px 90px rgba(26,22,18,.12)" }}>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2.4rem", fontWeight: 400, fontStyle: "italic", color: "var(--charcoal)", margin: "0 0 16px" }}>{translate("orderSuccessTitle")}</h1>
          <p style={{ fontSize: "1rem", color: "var(--muted)", lineHeight: 1.8, marginBottom: "16px" }}>
            {translate("orderSuccessSub")}
          </p>
          {orderId && (
            <div style={{ background: "var(--pearl)", padding: "12px 24px", borderRadius: "8px", border: "1px solid var(--border2)", display: "inline-block", marginBottom: "32px" }}>
              <span style={{ fontSize: ".85rem", color: "var(--muted)" }}>{translate("orderNumberLabel")} </span>
  ...
  if (cart.length === 0) {
    return (
      <div style={{ minHeight: "100vh", background: "radial-gradient(circle at 50% 30%, rgba(201,168,76,.08) 0%, rgba(250,250,248,1) 70%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px", direction: dir, fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "'Cinzel', serif" }}>
        <div style={{ textAlign: "center", background: "var(--white)", padding: "50px 40px", borderRadius: "16px", border: "1px solid var(--border)", boxShadow: "0 20px 60px rgba(26,22,18,.06)", maxWidth: "420px", width: "100%" }}>
          ...
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2.2rem", fontStyle: "italic", color: "var(--charcoal)", margin: "0 0 10px" }}>{translate("emptyCartTitle")}</p>
          <p style={{ fontSize: ".9rem", color: "var(--muted)", marginBottom: "28px" }}>{translate("emptyCartSub")}</p>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "radial-gradient(ellipse at 50% 0%, rgba(201,168,76,0.06) 0%, rgba(250,250,248,1) 60%)", direction: dir, fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit" }}>
      {/* Header */}
      <header style={{ background: "rgba(26, 22, 18, 0.95)", backdropFilter: "blur(12px)", padding: "0 48px", height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100, borderBottom: "1px solid rgba(201,168,76,.2)", boxShadow: "0 4px 25px rgba(0,0,0,.25)" }}>
        <Link to="/" style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none" }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(201,168,76,.9)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ transform: dir === "ltr" ? "rotate(180deg)" : "none" }}>
            <line x1="19" y1="12" x2="5" y2="12" /><polyline points="12 19 5 12 12 5" />
          </svg>
          <span style={{ color: "rgba(201,168,76,.85)", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "'Cinzel', serif", fontSize: ".85rem", fontWeight: 600 }}>{translate("backToStore")}</span>
        </Link>
      ...
      <div style={{ textAlign: "center", padding: "48px 24px 24px" }}>
        <p style={{ fontFamily: "'Cinzel', serif", fontSize: ".65rem", letterSpacing: ".45em", color: "var(--gold-deep)", textTransform: "uppercase", marginBottom: "8px" }}>{translate("checkoutSubtitle")}</p>
        <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "2.6rem", fontWeight: 500, fontStyle: "italic", color: "var(--charcoal)", margin: 0 }}>{translate("checkoutTitle")}</h1>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", maxWidth: "520px", margin: "0 auto 44px", padding: "0 24px" }}>
        {[
          { num: "1", label: translate("stepCart"), status: "completed" },
          { num: "2", label: translate("stepShipping"), status: "active" },
          { num: "3", label: translate("stepPayment"), status: "pending" }
        ].map((step, i) => (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
          ...
          <section style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: "12px", padding: "36px", boxShadow: "0 10px 30px rgba(26,22,18,.03)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "24px", paddingBottom: "14px", borderBottom: "1px solid var(--border)" }}>
              ...
              <h2 style={{ fontFamily: "'Cinzel', serif", fontSize: ".82rem", letterSpacing: ".2em", textTransform: "uppercase", color: "var(--gold-deep)", margin: 0, fontWeight: 700 }}>
                {translate("shippingAddressTitle")}
              </h2>
            </div>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "18px" }} className="checkout-form-grid">
              <div style={{ gridColumn: "1 / -1", display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("fullName")} <span style={{ color: "#e74c3c" }}>*</span></label>
              ...
              <div style={{ gridColumn: "1 / -1", display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("phone")} <span style={{ color: "#e74c3c" }}>*</span></label>
                <input type="tel" value={customerPhone} onChange={e => setCustomerPhone(e.target.value)}
                  placeholder={translate("phonePlaceholder")}
                  style={{ padding: "13px 16px", border: `1px solid ${formErrors.customerPhone ? "#e74c3c" : "var(--border2)"}`, borderRadius: "8px", fontSize: ".92rem", outline: "none", background: "var(--white)", direction: "ltr", textAlign: dir === "rtl" ? "right" : "left" }}
                />
                {formErrors.customerPhone && <span style={{ color: "#e74c3c", fontSize: ".75rem" }}>{formErrors.customerPhone}</span>}
              </div>

              <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("governorate")} <span style={{ color: "#e74c3c" }}>*</span></label>
                <select value={governorate} onChange={e => setGovernorate(e.target.value)}
                  style={{ padding: "13px 16px", border: `1px solid ${formErrors.governorate ? "#e74c3c" : "var(--border2)"}`, borderRadius: "8px", fontSize: ".92rem", outline: "none", background: "var(--white)", cursor: "pointer", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit" }}
                >
                  <option value="">{translate("selectGovernorate")}</option>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("city")} <span style={{ color: "#e74c3c" }}>*</span></label>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("district")} <span style={{ color: "#e74c3c" }}>*</span></label>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("street")} <span style={{ color: "#e74c3c" }}>*</span></label>
              ...
              <div style={{ gridColumn: "1 / -1", display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("building")}</label>
              ...
              <div style={{ gridColumn: "1 / -1", display: "flex", flexDirection: "column", gap: "6px" }}>
                <label style={{ fontSize: ".82rem", fontWeight: 700, color: "var(--charcoal)" }}>{translate("notesOptional")}</label>
                <textarea value={orderNotes} onChange={e => setOrderNotes(e.target.value)}
                  placeholder={translate("orderNotesPlaceholder")}
                  rows={3}
                  style={{ padding: "13px 16px", border: "1px solid var(--border2)", borderRadius: "8px", fontSize: ".92rem", outline: "none", background: "var(--white)", resize: "vertical", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit" }}
                />
              </div>
            </div>
          </section>
          ...
          <section style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: "12px", padding: "36px", boxShadow: "0 10px 30px rgba(26,22,18,.03)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              {[
                { key: "cod" as const, icon: "💵", title: translate("cod"), desc: translate("codDesc") },
                { key: "vodafone" as const, icon: "📱", title: translate("vodafone"), desc: translate("vodafoneDesc") },
              ].map(opt => {
        ...
        <div style={{ position: "sticky", top: "84px", display: "flex", flexDirection: "column", gap: "20px" }} className="checkout-summary-sticky">
          <div style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: "12px", overflow: "hidden", boxShadow: "0 10px 30px rgba(26,22,18,.05)" }}>
            ...
            <div style={{ padding: "22px 24px 18px", borderBottom: "1px solid var(--border)", background: "linear-gradient(135deg, var(--pearl), var(--off-white))", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontSize: ".8rem", color: "var(--muted)", fontWeight: 600 }}>{cart.length} {cart.length === 1 ? translate("item") : translate("items")}</span>
            </div>
                ...
                return (
                  <div key={line.product.id} style={{ display: "flex", gap: "14px", padding: "16px 20px", borderBottom: "1px solid var(--border)", alignItems: "center" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: ".78rem", color: "var(--muted2)", marginTop: "2px" }}>{translate("qty")}: <strong>{line.qty}</strong></div>
                      {avail < 3 && avail > 0 && <div style={{ fontSize: ".7rem", color: "#d9534f", marginTop: "2px", fontWeight: 600 }}>⚠ {lang === 'ar' ? `متبقي ${avail} قطع فقط` : `Only ${avail} left`}</div>}
                    </div>
                    <div style={{ fontFamily: "'Cinzel', serif", fontWeight: 700, fontSize: ".95rem", color: "var(--gold-deep)", flexShrink: 0 }}>
                      <span dir="ltr">{line.qty * line.product.price}</span> {translate("currency")}
                    </div>
                  </div>
                );
              })}
            ...
            <div style={{ padding: "18px 20px", borderBottom: "1px solid var(--border)" }}>
              <div style={{ display: "flex", gap: "8px" }}>
                <input type="text" value={promoInput} onChange={e => setPromoInput(e.target.value)}
                  ...
                  style={{ flex: 1, padding: "10px 14px", border: "1px solid var(--border2)", borderRadius: "6px", fontSize: ".88rem", outline: "none", background: "var(--off-white)", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit" }}
                ...
                >
                  {translate("applyPromo")}
                </button>
              </div>
              {promoError && <p style={{ color: "#e74c3c", fontSize: ".78rem", margin: "8px 0 0", fontWeight: 600 }}>{promoError}</p>}
              {promoApplied && <p style={{ color: "var(--gold-deep)", fontSize: ".82rem", margin: "8px 0 0", fontWeight: 700 }}>✓ {translate("promoAppliedMsg")} {promoApplied.pct}%</p>}
            </div>
            ...
            {shippingProgress < 100 && (
              <div style={{ padding: "16px 20px", borderBottom: "1px solid var(--border)", background: "rgba(201,168,76,.04)" }}>
                <p style={{ fontSize: ".8rem", color: "var(--muted)", marginBottom: "8px", textAlign: "center" }}>
                  {translate("freeShippingProgress")} <strong style={{ color: "var(--gold-deep)" }}>{800 - cartTotal} {translate("currency")}</strong> {translate("freeShippingMore")} 🚚
                </p>
            ...
            <div style={{ padding: "20px" }}>
              {[
                { label: translate("subtotal"), value: `${cartTotal} ${translate("currency")}` },
                ...(promoApplied ? [{ label: `${translate("promoCode")} (${promoApplied.pct}%)`, value: `-${discount} ${translate("currency")}`, green: true }] : []),
                { label: translate("shipping"), value: shippingFee === 0 ? `${translate("freeShipping")} 🎉` : `${shippingFee} ${translate("currency")}` },
              ].map((row, i) => (
                <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", fontSize: ".88rem", color: (row as any).green ? "#2a7a4a" : "var(--muted)" }}>
                  <span>{row.label}</span>
                  <span style={{ fontWeight: 700 }} dir="ltr">{row.value}</span>
                </div>
              ))}
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 0 4px", borderTop: "1px solid var(--border)", marginTop: "10px" }}>
                <span style={{ fontFamily: "'Cinzel', serif", fontSize: ".85rem", letterSpacing: ".15em", color: "var(--charcoal)", fontWeight: 700 }}>{translate("grandTotal")}</span>
                <span style={{ fontFamily: "'Cinzel', serif", fontSize: "1.4rem", color: "var(--gold-deep)", fontWeight: 800 }}><span dir="ltr">{grandTotal}</span> {translate("currency")}</span>
              </div>
            </div>
          </div>
          ...
          {paymentMethod === "vodafone" && (
            <div style={{ background: "var(--white)", border: "1px solid var(--gold)", borderRadius: "10px", overflow: "hidden", boxShadow: "0 4px 15px rgba(201,168,76,.08)" }}>
              ...
              <div style={{ background: "var(--pearl)", borderBottom: "1px solid rgba(201,168,76,.15)", padding: "16px 20px", display: "flex", gap: "14px", alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1 }}>
                  <h4 style={{ margin: "0 0 6px", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit", fontSize: "1.05rem", color: "var(--charcoal)", fontWeight: 800, lineHeight: 1.3 }}>
                    {translate("vodafoneSecure")}
                  </h4>
                  <p style={{ margin: 0, fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit", fontSize: ".9rem", color: "var(--charcoal)", opacity: 0.85, lineHeight: 1.6, fontWeight: 500 }}>
                    {translate("vodafoneSecureDesc")}
                  </p>
                </div>
              </div>
              ...
              {/* Input Section */}
              <div style={{ padding: "20px" }}>
                <label style={{ display: "block", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit", fontSize: ".95rem", fontWeight: 700, color: "var(--charcoal)", marginBottom: "10px" }}>
                  {translate("vodafoneNumber")} <span style={{ color: "#e74c3c", fontSize: "1.1em" }}>*</span>
                </label>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                {paymentMethod === 'vodafone' ? translate("confirmVodafone") : translate("confirmCod")}
              </>
            )}
          </button>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "24px", padding: "8px 0" }}>
            {[translate("securePaymentBadge"), translate("deliveryBadge"), translate("qualityGuaranteeBadge")].map(t => (
              <span key={t} style={{ fontSize: ".72rem", color: "var(--muted)", fontFamily: lang === "ar" ? "'Cairo', sans-serif" : "inherit", fontWeight: 600 }}>{t}</span>
            ))}
          </div>
        </div>
      </div>
